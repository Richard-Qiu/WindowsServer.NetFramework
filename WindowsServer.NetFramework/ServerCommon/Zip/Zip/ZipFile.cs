...
using WindowsServer.Zip.Encryption;
#endif

using WindowsServer.Zip.Core;
using WindowsServer.Zip.Checksums;
using WindowsServer.Zip.Zip.Compression.Streams;
using WindowsServer.Zip.Zip.Compression;

namespace WindowsServer.Zip.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="WindowsServer.Zip.Zip.ZipException">
