...
namespace System.Web.Http
{
    public static class ApiControllerExtensions
    {
        ...
        public static HttpResponseMessage JsonResponseJson(this ApiController controller, long code, string description, Dictionary<string, string> extraJsons = null)
        {
            JsonWriter writer = new JsonWriter(64);
            writer.WriteStartObject();
        ...
        public static HttpResponseMessage JsonResponseJson(this ApiController controller, long code, string description, Dictionary<string, string> extraJsons, Dictionary<string, object> extraValues)
        {
            JsonWriter writer = new JsonWriter(64);
            writer.WriteStartObject();
